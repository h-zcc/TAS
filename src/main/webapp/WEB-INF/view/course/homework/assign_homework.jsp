        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" id="homeworkForm" name="homeworkform" method="post"
                      action="/course/${course_id}/homework/assign" enctype="multipart/form-data"
                      onsubmit="return validateHomework()">
                    <div class="form-group">
                        <label class="col-lg-1 control-label">作业名称</label>
                        <div class="col-lg-11">
                            <input type="text" class="form-control" id="hw_title"
                                   name="title" data-length="30">
                        </div>
                    </div>
                    <div class="form-group">
